...
var fastBindall = __webpack_require__(4);
var idUtilities = __webpack_require__(0);
var typeIds = __webpack_require__(1);
var async = __webpack_require__(2);
var socketClient = __webpack_require__(6);
...
_.extend(GlipSocket.prototype, eventEmitter.prototype, idUtilities.prototype, {
  ...
  signin: function signin(callback) {
    ...
    this.request('/api/login', 'PUT', {
      ...
      if (!self.cookie) {
        return callback('Unable to authenticate');
      }
      return process.nextTick(callback);
    });
  },
